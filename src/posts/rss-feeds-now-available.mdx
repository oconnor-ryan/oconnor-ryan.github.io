...
<Frame src="/assets/images/blog/rss-format-example.jpg" caption="A snippet of my website's RSS file." useModal={true} css={{width: '100%', maxWidth: '700px', margin: 'auto'}}/>
...
<Frame 
  src="/assets/images/blog/rss-subscription-diagram.jpg" 
...
<Frame 
  src="/assets/images/blog/rss-update-diagram.jpg" 
...
<Frame src="/assets/images/blog/rss-step1.jpg" useModal={true} css={{width: '100%', maxWidth: '700px', margin: 'auto'}}/>

Click on 'Find Feeds In Current Tab'. 

<Frame src="/assets/images/blog/rss-step2.jpg" useModal={true} css={{width: '100%', maxWidth: '700px', margin: 'auto'}}/>

> If no options are displayed, the 
> website either does not have an RSS file or it did not properly link the RSS
> file location. If you want to check for this file, you can look for the <img src="/assets/images/blog/rss-feed.jpg" style={{width: '25px', height: '25px', maxWidth: '25px', margin: 0, borderRadius: 0, display: 'inline'}}/> symbol
...
<Frame src="/assets/images/blog/rss-step3.jpg" useModal={true} css={{width: '100%', maxWidth: '700px', margin: 'auto'}}/>

Once you've successfully subscribed to that feed, select the 'Open Feed Reader'
option to view your inbox.

<Frame src="/assets/images/blog/rss-step4.jpg" useModal={true} css={{width: '100%', maxWidth: '700px', margin: 'auto'}}/>
...
<Frame src="/assets/images/blog/rss-filter1.jpg" useModal={true} css={{width: '100%', maxWidth: '700px', margin: 'auto'}}/>
...
<Frame src="/assets/images/blog/rss-filter2.jpg" useModal={true} css={{width: '100%', maxWidth: '700px', margin: 'auto'}}/>
...
<Frame src="/assets/images/blog/rss-filter3.jpg" useModal={true} css={{width: '100%', maxWidth: '700px', margin: 'auto'}}/>

Here is the result of these 2 rules added to my website.

<Frame src="/assets/images/blog/rss-filter4.jpg" useModal={true} css={{width: '100%', maxWidth: '700px', margin: 'auto'}}/>
...
<Frame src="/assets/images/blog/rss-opml-step1.jpg" caption="Open the settings in Feedbro." useModal={true} css={{width: '100%', maxWidth: '700px', margin: 'auto', paddingBottom: '1em'}}/>

<Frame src="/assets/images/blog/rss-opml-step2.jpg" caption="Click the Import/Export Feed Subscriptions (as OPML) buttons" useModal={true} css={{width: '100%', maxWidth: '700px', margin: 'auto'}}/>
