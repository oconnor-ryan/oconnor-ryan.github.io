---
title: My Template Post (MDX Edition)
description: >- 
  ...
  and all screens. I also want to test how MDX works in NextJS.

tags: []
date: 2023-07-19T00:00:00-05:00
draft: true
thumbnailSrc: /assets/images/me.jpg
thumbnailCaption: It's Me!
---
...
## Image Frame with custom \<Frame> Component
<Frame 
  src="/assets/images/me.jpg" 
  useModal={true}
  caption="MDX Works Here! Here's some lorem ipsum: Dolor Lorem dolor aliquip velit enim anim minim ullamco. Non culpa adipisicing est eu est ex officia. Ut laboris officia officia aliqua dolor ea enim quis est tempor. Laboris reprehenderit amet dolore aute velit do dolor magna ad Lorem magna cillum velit in." 
  css={{width: '85%', maxWidth: '600px', margin: 'auto'}}
/>
