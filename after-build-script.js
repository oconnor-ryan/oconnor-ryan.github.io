...
//remove default 404 generated by NextJS
fs.rmSync(path.resolve("./out/404.html"));
fs.rmSync(path.resolve("./out/404"), {recursive: true});

//Move the custom 404 page from ./out/notfound/index.html to ./out/404.html

fs.renameSync(path.resolve("./out/notfound/index.html"), path.resolve("./out/404.html"));
fs.renameSync(path.resolve("./out/notfound/index.txt"), path.resolve("./out/404.txt"));

//delete the not found directory
fs.rmSync(path.resolve("./out/notfound"), {recursive: true});
